...
export const ROUTES = [
    ...
    { hash: 'aural', module: 'aural', name: 'Aural', inNav: true, icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 14c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm5.3-3c0 3-2.54 5.1-5.3 5.1S6.7 14 6.7 11H5c0 3.41 2.72 6.23 6 6.72V21h2v-3.28c3.28-.49 6-3.31 6-6.72h-1.7z"></path></svg>', fullBleed: true },
    ...
    { hash: 'study', module: 'library', name: 'Study Mode', inNav: false, featureFlag: 'studyMode' },
...
export const LEARNING_PATH_PROGRESS_GUEST = 'knowledgeTester_learningPath_progress_guest';
export const LEARNING_PATHS_KEY_GUEST = 'knowledgeTester_learningPaths_guest';
