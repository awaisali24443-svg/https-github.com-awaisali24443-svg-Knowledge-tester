...
export const ROUTES = [
    ...
    { hash: 'paths', module: 'learning-path-generator', name: 'Learning Paths', inNav: true, icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-4 14h-2v-4H9V7h2v4h2v6zm-4-8H9V7h2v2z"></path></svg>' },
