...
export function initializeCardGlow() {
    ...
    const cards = document.querySelectorAll('.card, .dashboard-card, .category-card, .topic-item, .review-item, .saved-question-item, .saved-path-item');
    cards.forEach(card => {
        ...
        // Set the data-text attribute for the button glitch effect (if any buttons are inside)
